...
import cn.devinkin.bookstore.user.service.UserException;
import cn.devinkin.bookstore.user.service.UserService;
...
public class UserServlet extends BaseServlet {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * 2. 输入校验
         * 3. 调用service完成激活
         *  1. 保存错误信息到、form到request，转发到login.jsp
    ...
    public String active(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        /**
         * 1. 获取参数激活码
         * 2. 调用service#active(String code)
         *  1. 保存异常信息到request中
         *  2. 转发到msg.jsp
         * 3. 保存激活信息到request
         * 4. 转发到msg.jsp
    ...
    public String regist(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * 2. 补全：uid、code
         * 3. 输入校验
         *  1. 保存错误信息、form到request域，转发到regist.jsp
         * 4. 调用service方法完成注册
         *  1. 保存错误信息、form到request域，转发到regist.jsp
         * 5. 发邮件
         * 6. 保存成功信息，转发到msg.jsp
